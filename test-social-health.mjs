...
if (!(await page.locator('script[src*="site.js?v=20260904-1"]').count())) errors.push('Site script cache marker is missing');
...
if (!(await page.locator('#projectProducts').textContent()).includes('The Eden Project')) errors.push('VRF expansion lane is missing from the portfolio summary');
